## A first example of using web-server Google Colab to run an application in Bioprocess Library
...
it for up to 12 hours and then it is closed. It is pre-configured wiht Python 3.7 and some common libraries and you interact through a Coloab notebook 
that is based on Jupyter notebook. More about it you can find here...
